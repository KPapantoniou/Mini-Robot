...
df1 = pd.read_csv("D:\\panepistimio\\Thesis\\Micro-robot\\code\\simulation\\sim_pid_diff.csv")

plt.figure(figsize=(12, 6))
plt.plot(df1["Time"], df1["TargetSpeed"], label="Base Motor Speed", color="blue")
...
plt.plot(df1["Time"], df1["Diff_speed"], label="Diff Speed", color="green")
